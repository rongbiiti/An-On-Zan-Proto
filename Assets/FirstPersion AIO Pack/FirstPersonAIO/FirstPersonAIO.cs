    ...
    private void Update(){
        ...
        #region Look Settings - Update
            ...
            if (cameraInputMethod == CameraInputMethod.Traditional || cameraInputMethod == CameraInputMethod.TraditionalWithConstraints){
               ...
               // mouseYInput = mouseInputInversion == InvertMouseInput.None || mouseInputInversion == InvertMouseInput.X ? Input.GetAxis("Analog Y") : -Input.GetAxis("Analog Y");
               // mouseXInput = mouseInputInversion == InvertMouseInput.None || mouseInputInversion == InvertMouseInput.Y ? Input.GetAxis("Analog X") : -Input.GetAxis("Analog X");
